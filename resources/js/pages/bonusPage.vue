        ...
        >
            ...
            >
                <div class="relative z-20 flex flex-col pl-1">
                    ...
                    <h2 class="text-xs text-[#878787]">
                        Получай до 1000 каждые 24ч
                    </h2>
                </div>
                <button
                    class="relative z-30 w-max cursor-pointer rounded-[10px] bg-white px-6 py-2.5 duration-300 ease-in-out hover:opacity-80"
                >
                    Получить
                </button>
                <img
            ...
            >
                ...
                <div class="relative z-20 flex w-full gap-1">
                    <input
                        type="text"
                        class="w-full rounded-[10px] bg-white p-2.5 text-sm outline-0 placeholder:text-black"
                    ...
                    >
                        <img
                            ...
                            class="absolute -top-6 -left-5 h-[33px]"
                            alt=""
                            data-animate-image
                        />
                        Активировать
